...
export default function ExploreError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="mx-auto flex max-w-6xl flex-col items-center px-4 py-24 text-center">
      ...
      <h1 className="mt-4 text-xl font-semibold text-zinc-900">Couldn&apos;t load Explore</h1>
      <p className="mt-1 text-zinc-500">The course catalog couldn&apos;t be reached right now.</p>
